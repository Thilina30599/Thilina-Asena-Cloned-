...
Asena.addCommand({pattern: 'cnlog', fromMe: false, desc: Lang.UP}, (async (message, match) => {
    ...
    await message.sendMessage (Buffer.from (respoimage.data), MessageType.image, {mimetype: Mimetype.png, caption: `*◁○🤖𝓣𝓱𝓲𝓵𝓲𝓷𝓪 𝓑𝓸𝓽🤖 ChangeLogs ○▷*
 *🧞𝙑𝙚𝙧𝙨𝙞𝙤𝙣 5.2.3*
_2021/08/08_
◉mmpack updated
...
_Conz : Lode404_
🤖𝓣𝓱𝓲𝓵𝓲𝓷𝓪 𝓑𝓸𝓽🤖 is a first Made in sri lanka 🇱🇰chat bot for WhatsApp. Makes it easy and fun to use Whatsapp.
♦https://youtu.be/mcEeIspWOpY
◼Github link : https://github.com/xneon2/Hashzi-X
*━⚜🤖𝓣𝓱𝓲𝓵𝓲𝓷𝓪 𝓑𝓸𝓽🤖 CHANGELOG⚜━*
`}) 
